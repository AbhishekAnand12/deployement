...
import { trainerTableCols } from '../../Config/constant';
    ...
    >
      <Paper>
        <Table sx={{ minWidth: 650 }}>
          <TableHead>
            <TableRow>
              {trainerTableCols.map(({ label, field }) => (
                <StyledTableCell align="center" key={trainerTableCols[field]}>
                  {label}
                </StyledTableCell>
              ))}
            </TableRow>
          ...
          <TableBody>
            {traineeData.map((dataitem) => (
              ...
              >
                ...
                {trainerTableCols.map(({ field, format }) => (
